...
💟 This mod has reached its end of life and is no longer supported or maintained by Kanaverum ([Jonathan Robertson](https://github.com/jonathan-robertson)). [Duncanois](https://github.com/Duncanois) has taken over as author as per Kanaverum's permission. Support can be found here: [Toxics 7D2D Discord](https://discord.gg/82bkRSqGVc)
